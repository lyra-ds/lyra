...
consumer compile. No public declaration, callback, ref, option object, example,
or generated documentation MAY name or structurally require a Radix, Base UI,
React Aria, or other primitive-vendor type. A source-only assertion MUST NOT
