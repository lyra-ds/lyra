...
| 4            | [Component architecture](./04-component-architecture.md)           | Owns package boundaries, public APIs, adapter contracts, SSR and hydration, vendor isolation, and versioning.       |
| 5            | [Quality and performance](./05-quality-performance.md)             | Owns severity, evidence architecture, test and release gates, bundle measurement, traceability, and manifests.      |
...
| 1. Design and product principles — primitive, component, and domain boundaries   | [Design and product principles](./01-design-product-principles.md) | [Component architecture](./04-component-architecture.md)                                                                                                                                         | [Acceptance criteria](./01-design-product-principles.md#acceptance-criteria) |
| 1. Design and product principles — native, external, and custom rules            | [Design and product principles](./01-design-product-principles.md) | [Component architecture](./04-component-architecture.md), [Quality and performance](./05-quality-performance.md)                                                                                 | [Acceptance criteria](./01-design-product-principles.md#acceptance-criteria) |
| 2. Tokens and visual language — color, type, spacing, radius, elevation, density | [Tokens and visual language](./02-tokens-visual-language.md)       | [Interaction and accessibility](./03-interaction-accessibility.md), [Quality and performance](./05-quality-performance.md)                                                                       | [Acceptance criteria](./02-tokens-visual-language.md#acceptance-criteria)    |
...
| 2. Tokens and visual language — light, dark, white-label, and forced colors      | [Tokens and visual language](./02-tokens-visual-language.md)       | [Interaction and accessibility](./03-interaction-accessibility.md), [Quality and performance](./05-quality-performance.md)                                                                       | [Acceptance criteria](./02-tokens-visual-language.md#acceptance-criteria)    |
| 2. Tokens and visual language — contrast and exceptions                          | [Tokens and visual language](./02-tokens-visual-language.md)       | [Interaction and accessibility](./03-interaction-accessibility.md), [Quality and performance](./05-quality-performance.md)                                                                       | [Acceptance criteria](./02-tokens-visual-language.md#acceptance-criteria)    |
| 3. Interaction and accessibility — keyboard and focus                            | [Interaction and accessibility](./03-interaction-accessibility.md) | [Tokens and visual language](./02-tokens-visual-language.md), [Component architecture](./04-component-architecture.md), [Quality and performance](./05-quality-performance.md)                   | [Acceptance criteria](./03-interaction-accessibility.md#acceptance-criteria) |
| 3. Interaction and accessibility — overlays, live regions, and announcements     | [Interaction and accessibility](./03-interaction-accessibility.md) | [Component architecture](./04-component-architecture.md), [Quality and performance](./05-quality-performance.md)                                                                                 | [Acceptance criteria](./03-interaction-accessibility.md#acceptance-criteria) |
| 3. Interaction and accessibility — touch, motion, RTL, locale, zoom, and reflow  | [Interaction and accessibility](./03-interaction-accessibility.md) | [Tokens and visual language](./02-tokens-visual-language.md), [Component architecture](./04-component-architecture.md), [Quality and performance](./05-quality-performance.md)                   | [Acceptance criteria](./03-interaction-accessibility.md#acceptance-criteria) |
...
| 3. Interaction and accessibility — browser and assistive-technology matrix       | [Interaction and accessibility](./03-interaction-accessibility.md) | [Quality and performance](./05-quality-performance.md)                                                                                                                                           | [Acceptance criteria](./03-interaction-accessibility.md#acceptance-criteria) |
| 4. Component architecture — compound and monolithic APIs                         | [Component architecture](./04-component-architecture.md)           | [Design and product principles](./01-design-product-principles.md), [Interaction and accessibility](./03-interaction-accessibility.md), [Quality and performance](./05-quality-performance.md)   | [Acceptance criteria](./04-component-architecture.md#acceptance-criteria)    |
...
| 4. Component architecture — React, Alpine, and CSS boundaries                    | [Component architecture](./04-component-architecture.md)           | [Design and product principles](./01-design-product-principles.md), [Interaction and accessibility](./03-interaction-accessibility.md), [Quality and performance](./05-quality-performance.md)   | [Acceptance criteria](./04-component-architecture.md#acceptance-criteria)    |
...
| 5. Quality and performance — SSR and hydration                                   | [Quality and performance](./05-quality-performance.md)             | [Component architecture](./04-component-architecture.md)                                                                                                                                         | [Acceptance criteria](./05-quality-performance.md#acceptance-criteria)       |
| 5. Quality and performance — contract, accessibility, visual, and browser tests  | [Quality and performance](./05-quality-performance.md)             | [Tokens and visual language](./02-tokens-visual-language.md), [Interaction and accessibility](./03-interaction-accessibility.md), [Component architecture](./04-component-architecture.md)       | [Acceptance criteria](./05-quality-performance.md#acceptance-criteria)       |
| 5. Quality and performance — external-dependency evidence                        | [Quality and performance](./05-quality-performance.md)             | [Design and product principles](./01-design-product-principles.md), [Interaction and accessibility](./03-interaction-accessibility.md), [Component architecture](./04-component-architecture.md) | [Acceptance criteria](./05-quality-performance.md#acceptance-criteria)       |
...
- **Critical workflow:** A supported workflow whose failure meets the shared
...
- **Consumer entry:** One documented public package entry imported by a
  consumer fixture and measured with its complete production dependency graph.
- **Scenario bundle:** A fixed representative application composition that
  imports only public consumer entries and measures shared-dependency effects.
- **ADR:** An architectural decision record that captures the decision owner,
