...
The pages explain four compound parts, native refs/props/ownership, controlled eligible keyboard semantics, real mounted panels, one complete exported ProjectTabs example, exact SSR/hydration requirements and manual migration/Styles floor. No runtime/source/dependency/config/service/remote action. Task27 Alpine and remaining V1 work continue. See `.batuta/v1-tabs-public-docs-verification.md`.
