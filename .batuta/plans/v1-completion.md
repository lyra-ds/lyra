...
- [ ] 26. CreateWorkspaceDialog lifecycle — critical incumbent compatibility/migration design technically reviewed3DONE/no findings; next high runtime plus two existing real consumer examples, then separate public MDX migration/docs. Current native3/3 immediate-close failure documented; exact request/result operation contract, same Dialog ownership, Alpine unsupported. See .batuta/specs/2026-09-10-create-workspace-lifecycle-design.md.
