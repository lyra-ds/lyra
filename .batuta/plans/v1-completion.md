...
- [ ] 33. React safe initial modal destination — high, first bounded Task31 slice. Scope four current modal source/browser/SSR owners, private internal/use-initial-focus.ts and directbrowser test, React minorchangeset and owner-generated catalogs. Accept exact .batuta/specs/2026-09-09-react-modal-initial-focus-design.md; threeengine hidden-first/declared/fallback/lifecycle/StrictMode/SSR/native and negative proof, retain return/Tab/Escape. Public docs follow immediately; no validation/inert/dynamic/topmost qualification by this slice.
