...
**Created:** 2026-09-18 · **Status:** approved by the maintainer on 2026-09-18 (single consolidated guide; publication by PR B merge)
...
- [ ] 3. Open, verify and merge PR A — release/critical
      Depends on: 2
...
- [ ] 4. Create the version commit — release/critical
      Depends on: 3
...
- [ ] 5. FileUpload numerical evidence on the candidate pair — evidence/critical
      Depends on: 4
...
- [ ] 6. Package, consumer and compatibility gates on the candidate — evidence/critical
      Depends on: 4
...
- [ ] 7. Three-engine source suites on the candidate — evidence/critical
      Depends on: 4
...
- [ ] 8. Packed Alpine public run — evidence/critical
      Depends on: 6
...
- [ ] 9. Retained media screening and Dropdown native tap on the candidate — evidence/critical
      Depends on: 6
...
- [ ] 10. Candidate binding artifacts — evidence/critical
...
- [ ] 11. Ledger `schemaVersion: 2`, specification status flips, compatibility table — release/critical
      Depends on: 10
