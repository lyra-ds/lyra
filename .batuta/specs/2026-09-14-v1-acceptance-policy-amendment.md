...
> **2026-09-15 superseding note:** the approved [V1 Automated Core runtime-scope decision](2026-09-15-v1-runtime-scope-proposal.md) supersedes the blanket missing-family-protocol prerequisite above for the incumbent V1 Automated Core release profile only. Families with no already-approved numerical protocol — located as Overlay, Tabs and DataTable — MAY be explicitly deferred as a non-PASS disposition. FileUpload and every other already-approved numerical budget, all applicable functional, browser, accessibility, media, platform, security and release requirements, and the immutability and candidate-binding rules of this section remain in force unchanged. The prerequisite above remains fully in force for the Full profile.
...
> **2026-09-15 acceptance clarification:** an explicitly approved numerical deferral under the [runtime-scope decision](2026-09-15-v1-runtime-scope-proposal.md) must be recorded as such, not treated as missing required evidence or a runtime PASS. A later core acceptance implementation may admit that disposition only when every preserved budget, applicable functional requirement and artifact-binding prerequisite passes. Missing or failed required evidence still blocks promotion. This documentation change neither implements that mechanism nor promotes a reference.
...
> **2026-09-15 superseding note:** for the incumbent V1 Automated Core release profile, the approved [V1 Automated Core runtime-scope decision](2026-09-15-v1-runtime-scope-proposal.md) supersedes the missing-family-protocol prerequisite sentence above for families with no already-approved numerical protocol (located as Overlay, Tabs and DataTable), which MAY be explicitly deferred as non-PASS. No numeric threshold is invented here, and FileUpload plus all already-approved numerical budgets remain mandatory.
