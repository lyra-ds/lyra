...
| --- | --- | --- |
| Final current-artifact qualification — local | Reconcile the seven recorded migration-growth overruns with the approved repairs and fixed reference. Preserve every existing ceiling unless a separately supported decision authorizes a change. | All applicable checks pass; fresh exact artifact identities agree. Reused evidence has explicit byte/owner/environment applicability. No historical measurement is relabeled as the new package pair. |
