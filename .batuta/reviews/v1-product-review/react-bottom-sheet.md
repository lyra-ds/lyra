...
The maintainer subsequently authorized the narrow CSS repair. It now passes BottomSheet18/18 and Dialog/Drawer18/18 on fresh Styles packaging, plus full common gate/stylelint/parity. See `react-bottom-sheet-focus.md`. Earlier16/18 evidence remains immutable historical regression proof, superseded only for this exact repaired artifact/profile slice.
