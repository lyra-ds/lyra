...
- [ ] Next: design the explicit opener/return-target and successor contract for unprepared mouse compositions. Actual WebKit mouse opening still captures body in current product; this V1 gap remains required and unresolved. No new API selected. No executor or browser/server remains running.
