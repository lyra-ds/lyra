...
- [x] Tooltip focused-lifecycle fixture verified — OpenCode GLM/low, no retry; Chromium/SSR8, WebKit7, Firefox7 plus disabled-blur-close RED/restored GREEN and static gates PASS. Runtime unchanged. Commit pending; see .batuta/v1-tooltip-focus-fixture-verification.md.
