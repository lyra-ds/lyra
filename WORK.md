...
- [x] Obsolete experimental checkout freeze repaired — critical/controller, no retry; policy10/10 from baseline8/10, canonical release108/108 + CLI/format PASS; GLM3/3 DONE/no findings/unchanged guard. Commit pending; see .batuta/v1-maintenance-policy-verification.md. Worktree now has its own frozen current dependency installation.
- [ ] Continuous completion authorized on 2026-09-09. BottomSheet runtime/examples/docs complete; selected Dependabot maintenance next; dependency PR triage recorded. Follow .batuta/plans/v1-completion.md. No dependency updates installed yet.
