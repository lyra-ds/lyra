...
- [x] FileUpload removal focus fixtures verified — OpenCode GLM/low, no retry; Chromium/SSR40, WebKit39, Firefox39 and static gates PASS; disabled outside-focus reset RED/restored GREEN. Runtime unchanged. Commit pending; see .batuta/v1-file-upload-focus-fixtures-verification.md.
