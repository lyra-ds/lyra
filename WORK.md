...
- [x] BottomSheet return-focus runtime verified — Codex gpt-5.6-terra/high after two medium setup failures, one high verification retry; native6/6, Chromium/SSR24, WebKit21, types/lint/format PASS; GLM3/3 DONE, no findings, unchanged guard. Implementation pending; see .batuta/v1-bottom-sheet-focus-verification.md. Documentation/examples follow immediately.
- [ ] Continuous completion authorized on 2026-09-09. BottomSheet runtime verified; docs/examples next; dependency PR triage recorded. Follow .batuta/plans/v1-completion.md. No dependency updates installed yet.
