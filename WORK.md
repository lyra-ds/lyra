...
## Popover RTL alignment repaired — 2026-09-15

At390944a, GLM scout +controller packed geometry reproduced wrong explicit RTL edge160px. Codex/Terra medium isolated worktree; stalled sandbox pnpm commands stopped only for this executor, continued implementation with controller-owned tests. One implementation retry fixed class/parity regressions and readiness. Final logical CSS extension +Popover-only physical auto inline geometry keeps shared helpers/classes/canonical prefix unchanged. Settled packed60/72→72/72; sourceReact105/Alpine66PASS, new original-code regression subset2expectedfails peradapter, exact restore; common/types/lint/parity/sizePASS. Independent GLM3DONE after auto-center hypothesis retracted from actual union/runtime domain. New3package hashes in `.batuta/reviews/v1-product-review/popover-rtl-alignment.md`; raw MAIN `.batuta/runs/popover-rtl-20260915/`, completion.json records squash commit. Source/distribution integrated, temporary resources cleaned. Prior exact-artifact proofs including FileUpload are historical until refreshed/justifiably reused for new hashes. Remaining applicable media/platform and consolidated acceptance separate. No remote/release/container/resource/budget/pointer/ledger or old-loop change.

## Popover native keyboard slice observed — 2026-09-15

At513418b, OpenCode/GLM read-only scout, controller packed production consumer. React/Alpine×Chromium/Firefox four plain Tab/Shift+Tab cases PASS; WebKit React initial plain-Tab precondition failed on native Before button, reproduced on independent button/input/button page. Two WebKit Option+Tab cases then PASS with explicit Alt modifier; do not report unqualified three-engine plain-Tab PASS. Enter/Space opening, natural forward/reverse exit, closed-content skip, Escape restore and prevention/removal control proved; no synthetic focus seed. Same archive hashes/450React+3Alpine+20Styles files;2157tracked unchanged, assets identical, own temporary consumer/script/browser/server cleaned. No product defect/fix, permanent test, implementation retry/escalation or broad rerun. Report `.batuta/reviews/v1-product-review/popover-native-tab.md`; raw MAIN `.batuta/runs/popover-native-tab-20260915/`, completion.json records commit. Remaining media/direction/touch mapping, native platform observations and consolidated acceptance separate. No preferences/resources/remote/release/policy/pointer change or old-loop restart.

## FileUpload current runtime verified — 2026-09-15

At3ea446a, controller ran existing `pnpm performance:file-upload` natively with Node24.18.0; exit0, six operations×30 samples after three warm-ups,100items/20attempts. Maximum p951.200ms/worst1.400ms, longest task0 in measured windows, existing limits unchanged. Exact React/Styles hashes match shared candidate;2156tracked/473shipped files unchanged, clean before reporting, producer temp cleanup complete. Existing validator/renderer rechecked captured JSON. No implementation/delegation, retry, new runner or broad test rerun. `.batuta/reviews/v1-product-review/file-upload-current-runtime.md`; raw MAIN `.batuta/runs/file-upload-current-runtime-20260915/`, commit in completion.json. Fresh measurement complete, canonical pointer0003123e unchanged. Next bounded work: remaining applicable media/interaction mapping; native Linux/Windows observations and final acceptance separate. No product/dependency/policy or remote/release/container/resource action.

## Remaining acceptance consolidated — 2026-09-15

At d21c78f, OpenCode/GLM read-only research plus one correction; controller verified contract/CLI/identity claims and2155 unchanged tracked files. Current disposition: `.batuta/reviews/v1-product-review/remaining-acceptance.md`. Next executable lot: `pnpm performance:file-upload` on a clean pinned native checkout, capture raw JSON and exact candidate identities; accepted0003123e React/Styles0.5.0 hashes differ from current pair, no performance failure asserted. No-arg CLI does not write canonical reports; preserve acceptance pointer. Then bounded media/interaction evidence mapping, ordinary native Linux/Windows observations, and consolidated acceptance after prerequisites. Already-completed source/packed/compatibility/budget slices retained; numerical deferral settled, Full unchanged. No new automated queue, benchmark/producer, test/build run, product edit or remote/container/release action. Raw MAIN `.batuta/runs/v1-remaining-consolidation-20260915/`; commit identity in completion.json.

## Dropdown native tap slice verified — 2026-09-15

Verification-only at d6cf5cc: OpenCode/GLM scout, controller packed production consumer proof, independent GLM3/3 DONE after one review-only retry (first external read denied; inline retry completed). React/Alpine×Chromium/Firefox/WebKit six cases PASS: trusted native touch opening, enabled action once, close plus trigger focus restored, outside action/dismissal without extra selection; fixture click-interception control detected and exact removal restores selection/focus. Disabled item model not qualified. No product defect/fix, implementation retry or escalation. Archive/extracted hashes unchanged;450React/3Alpine/20Styles shipped files match checkout;2154tracked files unchanged before records, reviewer unchanged guards pass. No physical-device/geometry/full-Dropdown/performance/OS qualification. Temporary consumer/script/browsers/server removed; no permanent suite or broad rerun. See `.batuta/reviews/v1-product-review/dropdown-native-tap.md`; raw MAIN `.batuta/runs/dropdown-native-tap-20260915/`. Commit identity is recorded in that run's completion.json. Remaining applicable media/platform/FileUpload runtime/final-acceptance obligations stay separate. No old-loop restart, next queue, remote/release/container action or policy/pointer promotion.

## Tooltip native submit-button tap verified — 2026-09-15

Verification-only at e9b6cd6: OpenCode/GLM bounded scout, controller native production consumer proof, independent GLM3/3 DONE. React/Alpine×Chromium/Firefox/WebKit six cases PASS: real touchscreen taps, coarse/no-hover media, initialized Tooltip semantics, native submit exactly once per tap; capture-prevention fixture control blocks action and exact listener removal restores it. No product defect/fix or synthetic-click substitution. Archive identities unchanged;450React/3Alpine/20Styles shipped files match checkout;2153tracked files unchanged before managed records. Reviewer found maxTouchPoints1/0/0; corrected prose, trusted touch-event proof retained. No physical-device/target-size/full-Tooltip/performance qualification. Temporary fixture/script/browsers/server removed; no permanent suite or broad rerun. See `.batuta/reviews/v1-product-review/tooltip-native-tap.md`; raw MAIN `.batuta/runs/v1-media-next-20260915/`. Remaining media/interaction/platform and final-acceptance obligations stay separate; runtime-scope approval remains settled. No next queue, baseline promotion or remote/container/release action.

## Approved runtime scope enacted in documentation — 2026-09-15

The maintainer replied “aprovado” to proposal ba84ecc and its explicit scope question. OpenCode/GLM low documentation lane updated the five approved files; controller clarified managed historical wording and future acceptance disposition. Canonical Automated Core/quality prose and September12/14 prerequisite notes now enact the V1-only deferral of missing Overlay/Tabs/DataTable numerical protocols as non-PASS, preserving FileUpload/all approved budgets, other applicable functional/media/platform/release requirements, Full and immutable candidate binding. No blanket other-family exemption. Controller checked seven added link occurrences/anchors, insertion-only changes to canonical/prior decision text,2148 protected tracked hashes, diff hygiene and existing v1-release checker PASS. No product tests/builds/benchmarks, ledger/validator/pointer edits or promotion. Executor's final redundant link command was denied by its CLI; controller completed the read-only checks with HTML-anchor support, so no executor verification claim is relied on. No implementation retry/escalation. See `.batuta/specs/2026-09-15-v1-runtime-scope-proposal.md`; raw MAIN `.batuta/runs/v1-runtime-scope-enactment-20260915/`. Approval is settled; remaining applicable evidence and eventual core acceptance remain separate. No new queue or remote/release/container action.

## Runtime-scope proposal ready; approval pending — 2026-09-15

At acd4e80, read-only OpenCode/GLM research plus independent3/3 DONE/no findings, unchanged guards; controller checked normative sources and links. Quality specification section433-449 explicitly requires complex-family numerical responsiveness protocols; current Automated Core defers manual evidence only. No approved numerical Overlay/Tabs/DataTable protocols were located in the bounded current audit. Concrete proposal `.batuta/specs/2026-09-15-v1-runtime-scope-proposal.md` recommends explicitly deferring new numerical protocols for those families in V1 Automated Core, while preserving FileUpload/any other approved budgets and all applicable functional/platform/release gates. This reduces required performance evidence and needs an explicit maintainer/PRD-owner decision; user continuation did not approve it. Alternative: retain the current gate and define/measure missing family protocols. Canonical specs, validators, baselines and product unchanged; no tests/builds/new queue. Raw MAIN `.batuta/runs/v1-runtime-policy-20260915/`. Next: obtain scope decision before any enactment; no remote/release/container action.

## Packed Alpine public runtime complete — 2026-09-14

Verification-only at 1ed9c60: OpenCode/GLM research and independent review4/4 DONE, unchanged guards, no retry/escalation; controller reused32 existing public Alpine browser files against freshly packed/extracted Alpine+Styles. Native Chromium315/315, Firefox315/315, WebKit315/315:945 total, zero failed/pending. All public Alpine runtime imports resolved to the packed public ESM (including describeRecurrence); source-runtime fallback rejected. Existing Dropdown case fails on a no-op extracted plugin; original bytes restored before full passes. Archive hashes match the prior artifact/budget lots;2151 tracked files unchanged before managed records. No new tests/permanent runner/dependencies; common-suite evidence reused with unchanged state. Temporary config/consumer removed; raw MAIN `.batuta/runs/alpine-packed-runtime-20260914/`. See `.batuta/reviews/v1-product-review/alpine-packed-runtime.md`. Remaining: applicable family runtime policy/media/device evidence, native Linux/Windows observations and final acceptance. No baseline promotion, remote action or next loop.
...
## Bundle policy reconciled; migration acceptance remains pending — 2026-09-14

Read-only OpenCode/GLM research178.39s/unchanged guard and controller raw-JSON reconciliation. All11 changed absolute caps have explicit approval; all72 budgets pass in retained measurement. Five compositions match the September12 decision exactly, including all3 exceptions. Canonical standalone deltas identify9 React entries above3000B; absolute-cap approval explicitly does not waive migration ceilings. Historical --check remains FAIL466 differences; it compares architecture and approved measurement changes as well as hashes. Existing acceptance is FileUpload-only, no baseline overwrite. See `.batuta/reviews/v1-product-review/bundle-reference-reconciliation.md`; raw MAIN `.batuta/runs/bundle-reference-reconciliation-20260914/`. Next proposed scope: one acceptance-policy amendment disposing of remaining deltas and defining native budget versus exact-artifact checks and runtime prerequisites before any core acceptance extension. No new tests/builds, baseline promotion, product/CI edit, next lot or old-loop restart.

## Current artifacts checked; bundle reference pending — 2026-09-14

Verification-only at dc9d54f: OpenCode/GLM research151.42s/unchanged guard, controller existing-command execution. Styles/React/Alpine publint, React/Alpine packed attw, declaration/directive/CDN scans, size-limit, Styles packed consumer and React/Styles Vite/Next/CJS consumer PASS. React18.3.1/19.2.8 all7 phases each PASS, four captured P1 reports44/44 exact named cases; same React658d9faf/Styles74fd16fc tarballs across producers. Existing bundle collector:72/72 current budgets PASS, Alpine23335<=24200; exact historical --check FAIL466 differences against0003123e (architecture, lock, hashes, limits and measurements). Full current/reference JSON retained; no baseline acceptance or altered comparison. Built files/source unchanged; reuse matching common/source-browser evidence, no redundant full-suite run. See `.batuta/reviews/v1-product-review/current-artifact-validation.md`; raw MAIN `.batuta/runs/current-artifact-validation-20260914/`. Next: bounded historical bundle-reference/policy reconciliation; Alpine packed runtime and other platform/media/final acceptance remain unqualified. No next lot launched.
...
- [x] Task39 packed P1 React compatibility slice: highTerra407.07s + retry492.82s, criticalcontroller NodeSSR/act/report completion. Full frozen React18.3.1/19.2.8 each existing5phases plus11namedSSR+11namedhydration/native PASS;23unit, actualskippedcase exit0 rejected, wrong-operation creation fault RED/restoredPASS. Exacttarballs/frozenlocks/450Reactidentity/owncleanup PASS. GLM100.75s3DONE/unchangedguards/verifierPASS;4low observations adjudicated with teardown-console limitation explicit. See .batuta/v1-p1-react-compat-verification.md. Node types exception already8203b10; no furtherdeps/assets. Remaining baseline/scenario and fullprofile/ledger qualification open; no stableV1 claim.
...
- Final qualification preflight: controller Prettier corrected only changelog-table padding in the V1 profile README; table cell contents verified unchanged and pnpm lint PASS. Initial format failure retained under final-local-qualification-20260915. No product change or repeated behavioral tests; continue existing final gates.

- Final local qualification at 5ac8922: build/types/exports/packed consumers/React 18+19/Alpine 1,014 cases/FileUpload/policy/docs PASS; Tabs size remains 1,567 > 1,500 bytes. Codex/Terra medium+retry and high+retry optimization aborted at best 1,535 bytes; prototypes preserved, worktree removed, no product change. A Tabs-only 1,600-byte proposal is pending explicit approval. See .batuta/reviews/v1-product-review/final-local-qualification.md; media/native-platform/consolidated acceptance remain open.

- Approved Tabs cap applied (2026-09-16): OpenCode/GLM low, no retry/escalation; exact two-config-line change, Tabs 1,567/1,600 B, 1,601 B rejected, 72 absolute limits/common/budget tests/format PASS. Fresh archives bind all 479 unchanged runtime/CSS files. Complete native gate FAIL: five standalone and two scenario migration-growth overruns (19–75 B), recorded together without changing those limits. See .batuta/reviews/v1-product-review/tabs-approved-cap.md; no stable-release claim or remote action.

- Joint migration diagnosis (2026-09-16): guarded GLM read-only research plus controller exact archive comparison identifies the same Popover RTL change in all seven overruns; six JS entries each add235 raw bytes, no separate product defects found. One seven-value proposal awaits explicit approval. Existing final P1 screening passes195interactions/66axe; isolated Chromium native page zoom passes12cases at100/200/400%, with honest text-only/other-engine/touch limits. No product/budget changes. See .batuta/specs/2026-09-16-popover-migration-exceptions.md and .batuta/reviews/v1-product-review/current-media-and-zoom.md.

- Seven migration ceilings approved and applied (2026-09-16): OpenCode/GLM low, no retry/escalation; exact seven-value configuration diff. Public native gate PASS for72standalone/5scenarios/4CSS, seven+1B negatives reject, budget tests/common/format PASS. All three archive hashes and479shipped code files unchanged. Recorded size blockers closed; media/touch applicability, native-platform integration and consolidated acceptance remain open. See .batuta/reviews/v1-product-review/approved-migration-caps.md.

- Acceptance reconciliation (2026-09-16): corrected stale FileUpload/final-round instructions; existing final qualification and size proofs reused. Bounded GLM research plus controller governing-spec check confirms planning-only guard is intentional; no ledger/checker/pointer change. Native 200% page zoom contributes resize-text proof for observed fixtures, with no extra text-only-mode gate. Local draft integration PR prepared; push/PR authorization pending. Media/touch contract disposition, native Linux/Windows CI and separately scoped immutable candidate acceptance remain open. See .batuta/reviews/v1-product-review/acceptance-reconciliation.md.

- PR223 Windows portability repair: Codex/Terra medium+one retry, GLM independent3DONE. Five native failures traced to module separators, canonical checkout, esbuild inherited temporary cwd and npm launcher. Common/focused40/budget/actualLFcheckout/oldpathnegative/fixedchildcwd checksPASS. No product/budget/evidence rewrite; follow-up WindowsCI pending. Maintainer authorized merge after CI passes; GitHub still requires one approving review. See .batuta/reviews/v1-product-review/windows-bundle-portability.md.

- PR223 Windows follow-up: native run35158276664 passes all five prior bundle-tool failures, then exposes a site metadata assertion requiring LF in a valid CRLF _headers file. GLM/low one-line regex fix; controller originalCRLF RED/fixedCRLF PASS/wrongMIME RED/restoredLF PASS and full metadata suite PASS. Generated header restored byte-for-byte; no component/artifact/budget change. Raw MAIN .batuta/runs/pr223-ci/. Formal GitHub review still required; no merge.

- PR223 FileUpload Windows test portability: Codex/Terra medium+retry, CursorFable5.1 planapproval, GLM final3DONE. Common349evidence testsPASS; actualCRLF old5FAIL/fixed80PASS; all48canonicalmembers exact underautocrlf=true. Preservedproductioningest/locktimeout/securityassertions. RestrictLFpolicy toJSON/MD toprotectbinaryevidence. See .batuta/reviews/v1-product-review/windows-evidence-portability.md; WebKitfixture andnativeCI next, no merge.
...
- 2026-09-17 — V1 coarse-pointer targets: expanded nine measured CSS owners to 44px only for coarse pointers; fine geometry unchanged. Codex Terra medium, one fixture retry, high escalation, then controller critical correction of the fixture's missing public table class. Packed three-engine proof: zero undersized observations. Styles 314 tests, focused 8, matrix 28, parity/stylelint/format and the 72/5/4 budget gate pass; original CSS fails the new regression. GLM final independent review: three criteria DONE, no findings. Evidence: `.batuta/reviews/v1-product-review/coarse-pointer-targets.md`; branch `fix/v1-coarse-targets`. PR227 security merged at aeb9fd19 after all CI/native checks passed. Candidate acceptance and release remain pending.

- PR228 CI follow-up: removed OS font-height assumptions from the new fine-pointer regression and serialized browser contexts to avoid shared temporary trace chunks. CSS and package archives unchanged. Controller critical diagnosis/repair; GLM review three DONE. Styles314, focused8, matrix28, formatting PASS; unconditional coarse-rule negative catches fine-pointer expansion. Original Linux failure retained.
