...
const manifest: ComponentEntry[] = [
  ...
  { slug: 'file-manager', name: 'FileManager', group: 'data', stacks: ['react', 'alpine', 'blade'] },
  { slug: 'breadcrumb', name: 'Breadcrumb', group: 'navigation', stacks: ['react', 'html', 'blade'] },
  { slug: 'tabs', name: 'Tabs', group: 'navigation', stacks: ['react', 'alpine', 'blade'] },
  { slug: 'pagination', name: 'Pagination', group: 'navigation', stacks: ['react', 'html', 'blade'] },
  ...
  { slug: 'sidebar-group', name: 'SidebarGroup', group: 'navigation', stacks: ['react', 'alpine', 'blade'] },
  {
  ...
  { slug: 'cookie-banner', name: 'CookieBanner', group: 'feedback', stacks: ['react', 'alpine', 'blade'] },
  ...
  { slug: 'checkbox-group', name: 'CheckboxGroup', group: 'form', stacks: ['react', 'html', 'blade'] },
  ...
  { slug: 'segmented-ring', name: 'SegmentedRing', group: 'display', stacks: ['react', 'html', 'blade'] },
  { slug: 'nav-link', name: 'NavLink', group: 'navigation', stacks: ['react', 'html', 'blade'] },
  { slug: 'app-sidebar', name: 'AppSidebar', group: 'navigation', stacks: ['react', 'alpine', 'blade'] },
  { slug: 'bottom-nav', name: 'BottomNav', group: 'navigation', stacks: ['react', 'html', 'blade'] },
  ...
  { slug: 'bottom-sheet', name: 'BottomSheet', group: 'overlay', stacks: ['react', 'alpine', 'blade'] },
  ...
  { slug: 'time-zone-picker', name: 'TimeZonePicker', group: 'form', stacks: ['react', 'alpine', 'blade'] },
  {
