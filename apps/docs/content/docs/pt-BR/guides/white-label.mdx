...
`--brand` é a cor-base obrigatória. Os outros três tokens têm defaults, mas defina
`--brand-contrast` sempre que a cor-base for clara o bastante para deixar texto branco ilegível.
