...
<Example id="structured" title="Cabeçalho, ações e rodapé" layout="plain">
...
<Example id="plain" title="Uma superfície simples" layout="plain">
...
<Example id="as-link" title="Um link totalmente clicável" layout="plain">
