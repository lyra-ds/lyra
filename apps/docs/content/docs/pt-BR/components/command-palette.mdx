...
- Durante a busca normal, o foco DOM fica no campo. As setas movem o foco virtual pelas opções,
  permitindo continuar digitando enquanto o descendente ativo muda; Enter seleciona o item ativo e
  Escape chama `onClose`. Um destino declarado no painel da paleta também é suportado.
