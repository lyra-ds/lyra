...
- Quando `onRemove` existe, ele renderiza um `type="button"` nativo com nome acessível “Remove”. Mantenha
  o propósito do conjunto e o texto da tag por perto para que a ação tenha contexto claro.
