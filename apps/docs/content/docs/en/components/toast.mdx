...
- The close button appears only with `onClose`, and its accessible name is the English string
  "Close notification". There is no prop to translate it — a limitation worth knowing before you ship
  a localized product.
