...
export const TOOLTIP_SCENARIOS = Object.freeze([
  ...
  defineScenario('tooltip', {
    ...
    checks: [
      ...
      [2, 'trigger-b', 'activation-count', 0],
      [2, 'document-focus', 'move-count-since-operation', 0],
      [3, 'tooltip-a', 'open', false],
      [3, 'document-focus', 'current', 'trigger-a'],
      [3, 'document-focus', 'move-count-since-operation', 0],
      [3, 'trigger-a', 'activation-count', 0],
      [3, 'trigger-b', 'activation-count', 0],
      [9, 'tooltip-b', 'open', true],
      [10, 'tooltip-b', 'open', false],
      [10, 'document-focus', 'current', 'outside-control'],
      [10, 'trigger-b', 'activation-count', 0],
    ],
    focus: [10, 'outside-control'],
    initial: {
      tooltipIds: ['tooltip-a', 'tooltip-b'],
    },
  }),
