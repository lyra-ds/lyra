...
export function installModalResourceTracker(scope = globalThis) {
  return installResourceTracker(scope, {
    ...
    layerBoundarySelector: '[data-modal-panel]',
    targetNameAttributes: ['data-modal-id', 'id'],
    connectedLayerSelector: '[data-modal-panel]',
    globalTrackerKey: '__LYRA_MODAL_RESOURCE_TRACKER__',
  });
}
