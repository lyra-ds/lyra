...
function extractComponents() {
  ...
  // PersonCell, and ActionBar move it to 62; Popover moves it to 63; Calendar moves it to 64; BottomSheet moves it to 65. The guard's job is
